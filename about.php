            ...
            <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                <div class="navbar-nav ml-auto py-0">
                    ...
                    <div class="nav-item dropdown">
                        <a href="Services.php" class="nav-link dropdown-toggle" id="servicesDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            Services
                        </a>
                    ...
                    <div class="owl-carousel team-carousel">
                        <div class="team-item">
                            ...
                            <div class="border border-top-0 text-center" style="padding: 30px;">
                                <h5 class="font-weight-bold">Jagdish Suthar</h5>
                                <span>Founder</span>
                            </div>
                        </div>
                        <div class="team-item">
