...
<head>
    <meta charset="utf-8">
    <title>FusionCore Technology - Creative Agency Website Template</title>
    ...
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.0.0-beta2/dist/js/bootstrap.bundle.min.js"></script>
        ...
        <!-- Customized Bootstrap Stylesheet --><!-- jQuery -->
    ...
    <div class="container-lg p-0">
        <nav class="navbar navbar-expand-lg bg-secondary navbar-dark">
            <a href="" class="navbar-brand">
                <img src="img/logo/fsuioncore.png" alt="FusionCore Logo">
            </a>
            ...
            <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                <div class="navbar-nav ml-auto py-0">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu border-0 rounded-0 m-0" aria-labelledby="servicesDropdown">
                            <!-- Web Development -->
                            <a href="web-development.html" class="dropdown-item">
                                <i class="fas fa-code"></i> Web Development
                            </a>
                            <!-- Mobile App Development -->
                            <a href="mobile-app-development.html" class="dropdown-item">
                                <i class="fas fa-mobile-alt"></i> Mobile App Development
                            </a>
                            <a href="web-development.html" class="dropdown-item">
                            <i class="fab fa-css3-alt"></i> Frontend Development
                            </a>
                            <!-- UI/UX Design -->
                            <a href="ui-ux-design.html" class="dropdown-item">
                                <i class="fas fa-paint-brush"></i> UI/UX Design
                            </a>
                            <!-- Digital Marketing -->
                            <a href="digital-marketing.html" class="dropdown-item">
                                <i class="fas fa-bullhorn"></i> Digital Marketing
                            </a>

                            <!-- Sub-Service Dropdown Example -->
                            <div class="dropdown-divider"></div>
                            <div class="nav-item dropdown">
                                <a href="#" class="dropdown-item dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    <i class="fas fa-cogs"></i> More Services
                                </a>
                            </div>
                        </div>
                    </div>
        ...
        <div id="header-carousel" class="carousel slide carousel-fade" data-ride="carousel">
            ...
            <div class="carousel-inner" >
                <div class="carousel-item active">
                    <img class="img-fluid" style="width: 100%;" src="img/carousel-1.jpg" alt="Image">
                    <div class="carousel-caption d-flex align-items-center justify-content-center">
                        <div class="p-5" style="width: 100%; max-width: 900px;">
                            <h5 class="text-white text-uppercase mb-md-3">Creative Services</h5>
                            <h1 class="display-4 text-white mb-md-5">Custom Web & App Development Company</h1>
                            <a href="" class="btn btn-primary py-md-2 px-md-4 font-weight-semi-bold mt-2"><b>Schedule a call</b></a>
                            <a href="" class=" py-md-2 px-md-4 font-weight-semi-bold mt-2"><b>Our Services <span>&#8594;</span></b></a>
                        </div>
                    </div>
                </div>
                <div class="carousel-item">
                    <img class="img-fluid" style="width: 100%;" src="img/carousel-2.jpg" alt="Image">
                    <div class="carousel-caption d-flex align-items-center justify-content-center">
                        <div class="p-5" style="width: 100%; max-width: 900px;">
                            <h5 class="text-white text-uppercase mb-md-3">Creative Services</h5>
                ...
                <div class="carousel-item">
                    <img class="img-fluid" style="width: 100%;" src="img/carousel-3.jpg" alt="Image">
                    <div class="carousel-caption d-flex align-items-center justify-content-center">
                        <div class="p-5" style="width: 100%; max-width: 900px;">
                            <h5 class="text-white text-uppercase mb-md-3">Creative Services</h5>
        ...
        <div class="container">
            <div class="row align-items-center pb-1">
                ...
                <div class="col-lg-7 mt-5 mt-lg-0">
                    ...
                    <h1 class="mt-2 mb-4">FusionCore Technologies: Your Trusted Partner in Web Development & Design</h1>
                    <p class="mb-4">At FusionCore Technologies, we understand the ever-evolving digital landscape and are committed to helping businesses thrive online. As a leading provider of web development and web design services, we deliver cutting-edge solutions that empower companies to build a strong online presence and drive growth.

With years of expertise in custom web development, UI/UX design, and digital strategies, we specialize in creating websites that are not only visually stunning but also highly functional and user-friendly. Whether you're looking for a simple landing page, a robust eCommerce platform, or a complex web application, FusionCore has the skills and tools to turn your vision into reality.</p>
                </div>
            </div>
            <div class="row mt-4">
                <div class="col-md-4">
                    <div class="d-flex align-items-center border mb-4 mb-lg-0 p-4" style="height: 120px;">
                        ...
                        <div class="d-flex flex-column">
                            ...
                            <p class="m-0">Ahmedabad,Gujrat,India</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="d-flex align-items-center border mb-4 mb-lg-0 p-4" style="height: 120px;">
                        ...
                        <div class="d-flex flex-column">
                            ...
                            <p class="m-0">info@fusioncoretechnologies.com</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 mb-5">
                    ...
                    <h5 class="font-weight-normal text-muted mb-4">We are a custom software development agency that focuses on providing quality software, website
                    and app development and has ensured greater quality and customer satisfaction.</h5>
                    ...
                    <div class="col-md-6 mb-5">
                            <div class="d-flex">
                                ...
                                <div class="d-flex flex-column">
                                    ...
                                    &#x2022; Customized Website<br>
                                    &#x2022; Website Redesign<br>
                                    <a class="font-weight-semi-bold" href="">Learn More <i class="fa fa-angle-double-right"></i></a>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 mb-5">
                        ...
                        <div class="col-md-6 mb-5">
                            <div class="d-flex">
                            <i class="fa fa-shopping-cart fa-3x text-primary mr-4"></i>

                                <div class="d-flex flex-column">
                                    <h4 class="font-weight-bold mb-3">E-Commerce Development</h4>
                        ...
                        <div class="col-md-6 mb-5">
                            <div class="d-flex">
                            <i class="fa fa-3x fa-mobile text-primary mr-4"></i>
                                <div class="d-flex flex-column">
                                    ...
                                    <a class="" href="">Learn More <i class="fa fa-angle-double-right"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 mb-5">
                    ...
                    <h5 class="font-weight-normal text-muted mb-4">Our team is the heart of everything we do. With a shared commitment to excellence and innovation, our experts are dedicated to making a difference in everything we create.</h5>
                    ...
                    <div class="owl-carousel team-carousel">
                        <div class="team-item">
                            <div class="position-relative">
                                <img class="img-fluid w-100" src="img/WhatsAppImage2024-11-17at09.15.19_56d3ad1a-Photoroom.jpeg" alt="">
                                <div class="team-overlay position-absolute d-flex align-items-center justify-content-center m-3">
                                    <div class="d-flex align-items-center justify-content-start">
                                        ...
                                        <a class="btn btn-outline-secondary rounded-circle text-center px-0" style="width: 38px; height: 38px;" href="https://www.linkedin.com/in/jagdish-suthar-575719219/"><i class="fab fa-linkedin-in"></i></a>
                                    </div>
                                </div>
                            </div>
                            <div class="border border-top-0 text-center" style="padding: 30px;">
                                <h5 class="font-weight-bold">Jigs Suthar</h5>
                                <span>CEO, Founder</span>
                            </div>
                        </div>
                        <div class="team-item">
                            <div class="position-relative">
                                <img class="img-fluid w-100" src="img/sanju.jpeg" alt="">
                                <div class="team-overlay position-absolute d-flex align-items-center justify-content-center m-3">
                                    <div class="d-flex align-items-center justify-content-start">
                                        <a class="btn btn-outline-secondary rounded-circle text-center mr-2 px-0" style="width: 38px; height: 38px;" href="#"><i class="fab fa-twitter"></i></a>
                                        <a class="btn btn-outline-secondary rounded-circle text-center mr-2 px-0" style="width: 38px; height: 38px;" href="#"><i class="fab fa-facebook-f"></i></a>
                            ...
                            <div class="border border-top-0 text-center" style="padding: 30px;">
                                <h5 class="font-weight-bold">Sandeep Suthar</h5>
    ...
    <div class="container-fluid bg-secondary text-white mt-5 pt-5 px-sm-3 px-md-5">
        <div class="row pt-5">
            ...
            <div class="col-lg-3 col-md-6 mb-5">
                <h5 class="font-weight-bold text-primary mb-4">Services</h5>
                <div class="d-flex flex-column justify-content-start">
                    <a class="text-white mb-2" href="#"><i class="fa fa-angle-right text-primary mr-2"></i>Web Development</a>
                    <a class="text-white mb-2" href="#"><i class="fa fa-angle-right text-primary mr-2"></i>Mobile Development</a>
                    <a class="text-white mb-2" href="#"><i class="fa fa-angle-right text-primary mr-2"></i>CMS & E-commerce</a>
                    <a class="text-white mb-2" href="#"><i class="fa fa-angle-right text-primary mr-2"></i>Frontend Development</a>
                    <a class="text-white" href="#"><i class="fa fa-angle-right text-primary mr-2"></i>Graphics Design</a>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 mb-5">
    ...
    <div class="container-fluid py-4 px-sm-3 px-md-5">
        <p class="m-0 text-center">
            &copy; <a class="font-weight-semi-bold" href="#">FusionCore Technology</a>. All Rights Reserved.
        </p>
    </div>
    <!-- Footer End -->
